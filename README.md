...
# Library Management System With TDD
> **Note:** This repository contains the core code of a E-learning Library Management System With TDD( Unit test, Feature test, Browser test- Laravel Dusk )
...
## About The Project
An integrated library system, also known as a library management system, is an enterprise resource planning system for a library, used to track items owned, orders made, bills paid, and patrons who have borrowed. In this project, I have practiced TDD along with Libarary Managemnet System.
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/Library-Management-With-TDD.git
```
